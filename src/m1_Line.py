...
class Point(object):
    ...
    def __eq__(self, p2):
        """
        # > take a look at the little blue circle and red arrow; it overrides, or redefines a builtin python thingie.
...
class Line(object):
    ...
    def clone(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        clone_start = self.start.clone()
        clone_end = self.end.clone()
        clone_line = Line(clone_start, clone_end)
        self.clone_count += 1
